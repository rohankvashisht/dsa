...
data_structures_folder_path = "../../data_structures/teamtreehouse"
sys.path.append(data_structures_folder_path)
...
def merge(left, right):
  ...
  # Iterate over left and right until we reach the
  # tail node of either
  while left_head or right_head:
    # If the head node of the left
    # is None, we're past the tail
