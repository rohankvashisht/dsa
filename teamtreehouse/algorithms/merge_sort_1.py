...
def split(list):
  ...
  Takes overall (k log n) time.
  """
  mid = len(list)//2

  """
  list[a,b] -> Goes from a to b-1
  list[:b] -> Goes from 0 to b-1
  list [b:] -> Goes from b to end
  """
...
def merge(left, right):
  ...
  """
  l = []
  i = 0 # tracks indexes in left list
  j = 0 # tracks indexes in right list
